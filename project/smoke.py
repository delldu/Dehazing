...
def export_onnx_model():
    ...
    # 1. Run torch model
    model, device = image_dehaze.get_trace_model() # get_dehaze_model() # get_trace_model()
    # model = model.feature_extract.encoder.layer1
    model.to(device)
    ...
    onnx_filename = "output/image_dehaze.onnx"
